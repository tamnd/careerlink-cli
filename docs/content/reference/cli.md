...
```
careerlink <command> [arguments] [flags]
```

Run `careerlink <command> --help` for the full flag list on any command. This
...
per operation you declare in `careerlink/domain.go`.
